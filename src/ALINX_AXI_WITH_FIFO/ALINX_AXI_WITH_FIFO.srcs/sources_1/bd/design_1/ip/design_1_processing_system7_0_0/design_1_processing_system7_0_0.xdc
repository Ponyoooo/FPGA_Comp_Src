...
# Clock constraints                                                        #
############################################################################
create_clock -name clk_fpga_0 -period "15.555" [get_pins "PS7_i/FCLKCLK[0]"]
set_input_jitter clk_fpga_0 0.46665
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_1 -period "7.777" [get_pins "PS7_i/FCLKCLK[1]"]
set_input_jitter clk_fpga_1 0.23331
#The clocks are asynchronous, user should constrain them appropriately.#
