...
HD_PWD='D:/Doc/Vivado2019_1/ALINX_AXI_WITH_FIFO/ALINX_AXI_WITH_FIFO.runs/design_1_AXI_FIFOIN_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI_FIFOIN_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI_FIFOIN_0_0.tcl
